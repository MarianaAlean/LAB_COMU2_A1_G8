...
import VCO_epy_block_0 as epy_block_0  # embedded python block
import math
import sip
import threading
...
class VCO(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "VCO")
        ...
        self.qtgui_freq_sink_x_1.set_y_axis((-140), (6e-6))
        ...
        self.connect((self.analog_noise_source_x_0, 0), (self.qtgui_time_sink_x_1_0, 0))
        ...
        self.connect((self.interp_fir_filter_xxx_0, 0), (self.qtgui_freq_sink_x_1, 0))
...
def main(top_block_cls=VCO, options=None):
