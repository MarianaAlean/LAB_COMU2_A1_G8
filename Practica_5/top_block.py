...
class top_block(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        # Variables
        ##################################################
        self.TablaVerdadConstelacion = TablaVerdadConstelacion = (-3-3j, -1-3j, 1-3j, 3-3j, 3-1j, 1-1j, -1-1j, -3-1j, -3+1j, -1+1j, 1+1j, 3+1j, 3+3j, 1+3j, -1+3j, -3+3j)
        self.M = M = len(TablaVerdadConstelacion )
        self.bps = bps = int(math.log(M,2))
        self.Sps = Sps = 8
        self.Rs = Rs = 32000
        self.samp_rate = samp_rate = Rs*Sps*10
        self.h = h = [1]*Sps
        self.Rb = Rb = Rs*bps
        ...
        self.digital_chunks_to_symbols_xx_0 = digital.chunks_to_symbols_bc(TablaVerdadConstelacion, 1)
    ...
    def get_TablaVerdadConstelacion(self):
        return self.TablaVerdadConstelacion

    def set_TablaVerdadConstelacion(self, TablaVerdadConstelacion):
        self.TablaVerdadConstelacion = TablaVerdadConstelacion
        self.set_M(len(self.TablaVerdadConstelacion ))
        self.digital_chunks_to_symbols_xx_0.set_symbol_table(self.TablaVerdadConstelacion)
    ...
    def set_Sps(self, Sps):
        ...
        self.set_samp_rate(self.Rs*self.Sps*10)
